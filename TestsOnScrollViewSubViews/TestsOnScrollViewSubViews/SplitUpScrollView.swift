...
class SplitUpScrollView: UIScrollView {
    ...
    */
    ...
    private(set) var viewLeftConstraint = NSLayoutConstraint()
    private(set) var viewTopConstraint = NSLayoutConstraint()
    ...
    */
    ...
    func frameDescription() {
//        print("bounds:\(self.bounds.origin.x) \(self.bounds.origin.y) \(self.bounds.size.width) \(self.bounds.size.height) ")
//        print("frames:\(self.frame.origin.x) \(self.frame.origin.y) \(self.frame.size.width) \(self.frame.size.height) ")
        
        
        
//        print("contentOffset, Size: \(self.contentOffset.x) \(self.contentOffset.y) \(self.contentSize.width) \(self.contentSize.height)")
        
        let pctRect = CGRect(x: self.contentOffset.x / self.contentSize.width,
